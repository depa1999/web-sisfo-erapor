...
<body>
	...
	if (isset($_POST['cari'])) {
		...
		$sql = "select * from siswa as s, guru as g, thn_ajar as t, nilai1 as n1 where 
                         n1.nis=s.nis and n1.nip = g.nip and n1.idtahun = t.idtahun
                         having 
                         nama_siswa like'%$cari%' and kelas='2' 
	...
	<div class="utama">
		...
		<div class="text-center"><a href="prnRapotAllPdf.php"><span class="fas fa-print">&nbsp;Print</span></a></div>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<a class="btn btn-outline-primary btn-sm" href="editRapot.php?kode=<?php echo $row['idnilai1'] ?>">Koreksi</a>
							<a class="btn btn-outline-danger btn-sm" href="hpsRapot.php?kode=<?php echo $row["idnilai1"] ?>" onclick="return confirm('Yakin dihapus?')">Hapus</a>
						</td>
					</tr>
				<?php
						$no++;
