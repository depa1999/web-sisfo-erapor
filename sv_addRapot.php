...
$jml_nilai=$_POST['jml_nilai']=$n_bindo+$n_agama+$n_pkn+$n_pjok+$n_mtk+$n_sbdp+$n_bjawa;
...
$sql="insert nilai1 values('','$nis','$nip','$thn_ajar','$semester','$n_bindo','$p_bindo','$n_agama','$p_agama',
'$n_pkn','$p_pkn','$n_mtk','$p_mtk','$n_pjok','$p_pjok','$n_sbdp','$p_sbdp','$n_bjawa','$p_bjawa','$jml_nilai')";
