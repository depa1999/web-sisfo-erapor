...
if (isset($_POST['cari'])){
	$cari=$_POST['cari'];
	$sql="select * from thn_ajar where username like'%$cari%' or
...
if (isset($_POST['cari'])){
	...
	$sql="select * from thn_ajar limit $awalData,$jmlDataPerHal";		
}
...
?>
<div class="utama">
	<h2 class="text-center" style="margin-top: 2cm;">Tahun Ajar</h2>
	<span class="float-left">
		<a class="btn btn-success" href="addAjar.php">Tambah Data</a>
	</span>
	<br><br>
	<ul class="pagination">
		<?php
	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<td>
				<a class="btn btn-outline-danger btn-sm" href="hpsAjar.php?kode=<?php echo $row["idtahun"]?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
